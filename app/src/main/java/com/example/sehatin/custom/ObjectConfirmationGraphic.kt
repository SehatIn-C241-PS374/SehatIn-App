 ...
 */
internal class ObjectConfirmationGraphic(graphicsOverlay: GraphicOverlay, private val confirmationController: ObjectConfirmationController) : GraphicOverlay.Graphic(graphicsOverlay) {
